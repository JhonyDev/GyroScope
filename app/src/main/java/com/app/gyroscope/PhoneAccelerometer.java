...
public class PhoneAccelerometer implements SensorEventListener {
    ...
    public PhoneAccelerometer(Context context) {
        mSensorManager = (SensorManager) context.getSystemService(Context.SENSOR_SERVICE);
        mWindowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        gyroListener = (GyroListener) context;
    }
    ...
    private void loadNewSensorData(SensorEvent event) {
        ...
        if (type == Sensor.TYPE_MAGNETIC_FIELD) {
            ...
            gyroListener.coordinateListener(x, y, z);
    ...
    public void onAccuracyChanged(Sensor sensor, int accuracy) {
        ...
        gyroListener.accuracyChanged(sensor, accuracy);
                ...
                if (SensorManager.getRotationMatrix(mRotationMatrix, null, bufferedAccelGData, bufferedMagnetData)) {
                    ...
                    if (!dontRemapCoordinates) {
                        SensorManager.remapCoordinateSystem(
                                ...
                                mRotationMatrix);
                        Log.i(TAG, "onSensorChanged: " + mRotationMatrix);
                    }
